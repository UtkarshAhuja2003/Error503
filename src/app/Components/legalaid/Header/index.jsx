        ...
        <div className='md:flex flex-row-reverse w-[90%] justify-between mx-auto mt-12 md:mt-24'>
            ...
            <div className='w-[90%] mx-auto md:w-[40%]'>
                ...
                <div className='md:w-[100%] mx-auto text-center md:text-left'>
                    <Link href="/legalAid/organisations"><button className='bg-[#ffb500] hover:bg-white hover:text-[#ffb500] border border-1 border-[#ffb500] ease-in-out duration-300 text-white rounded-md w-[144px] h-[40px] mt-6 mx-auto'>Get Aid</button></Link>
                </div>
            </div>
        </div>
    </div>
