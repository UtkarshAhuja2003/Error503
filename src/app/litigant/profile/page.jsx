            ...
            <div className='mx-[10%] mt-[5rem] font-defaultFont'>
                ...
                <div className='flex'>
                    ...
                    <div className='w-[30%] my-12'>
                        ...
                        <button onClick={(e)=>{handleLogout(e)}} disabled={false} className="w-full px-6 py-2 mt-4 text-white hover:shadow-md ease-in-out duration-300 bg-[#04434E] rounded-lg ">
                            Log Out
                        </button>
                    </div>
                </div>
