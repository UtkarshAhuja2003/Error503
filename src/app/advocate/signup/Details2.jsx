...
const Details2 = ({ gender,setGender,state,setState,barRegistrationNumber,setBarRegistrationNumber,courtType,setCourtType,district,setDistrict,courtState,setCourtState,highCourt,setHighCourt,bench,setBench,handleSubmit }) => {
    ...
    return (
        <div>
            <div className='py-6 mx-12'>
                ...
                <h2 className='mt-4 text-center text-2xl'>Ordinary Place of Practice</h2>
